...
gsap.from('.how-its-work__title', {
  scrollTrigger: {
    trigger: '.how-its-work__title',
    start: 'top 95%',
    toggleActions: "play none none none"
  },
  ease: "slow.inOut",
...
gsap.from('.how-its-work__subtitle', {
  scrollTrigger: {
    trigger: '.how-its-work__subtitle',
    toggleActions: "play none none none",
    scrub: false
  },
  ease: "slow.inOut",
...
gsap.from('.how-its-work__item', {
  scrollTrigger: {
    trigger: '.how-its-work__item',
    toggleActions: "play none none none"
  },
  ease: "slow.inOut",
  stagger: 0.25,
...
gsap.from('.price__subtitle', {
  scrollTrigger: {
    trigger: '.price__subtitle',
    toggleActions: "play none none none"
  },
  ease: "slow.inOut",
  delay: 0.2,
...
gsap.to(".accordion__content", {
  scrollTrigger: {
    trigger: ".accordion__content",
    toggleActions: "play none none none"
  },
  ease: "slow.inOut",
  x: 0,
...
gsap.from('.faq__description', {
  scrollTrigger: {
    trigger: '.faq__description',
    toggleActions: "play none none none"
  },
  ease: "slow.inOut",
  delay: 0.2,
...
/* harmony import */ var _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/gsap.min.js */ "./src/js/vendor/gsap.min.js");
...
/* harmony import */ var _vendor_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/ScrollTrigger.min.js */ "./src/js/vendor/ScrollTrigger.min.js");
/* harmony import */ var _vendor_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_2__);
...
function headerSticky(entries, headerObserver) {
  console.log(entries);
  if (entries[0].isIntersecting) {
    header.classList.remove('scroll')
  } else {
...
const headerObserver = new IntersectionObserver(headerSticky, options);
...
if (document.querySelectorAll('.faq__accordion').length > 0) {
...
if (document.querySelectorAll('.footer__copyright').length > 0) {
  const yearSpan = document.querySelector('.footer__copy span'),
    date = new Date(),
